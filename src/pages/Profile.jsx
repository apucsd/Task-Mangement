...
const Profile = () => {
  ...
  return (
    <div className="relative my-10 flex flex-col w-full min-w-0 mb-6 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 draggable">
      <div className="px-9 pt-9 flex-auto min-h-[70px] pb-0 bg-transparent">
          ...
          <div className="grow">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-wrap pr-2 mb-4 font-medium">
                  ...
                  <a className="flex items-center mb-2 mr-5 text-secondary-dark hover:text-primary">
                    ...
                    {user ? user.email : "contact@example.com"}
                  </a>
                </div>
              </div>
              <div className="flex flex-wrap my-auto">
                <a className="inline-block px-6 py-3 bg-blue-500 text-white mr-3 text-base font-medium leading-normal text-center align-middle transition-colors duration-150 ease-in-out border-0 shadow-none cursor-pointer rounded-2xl text-muted bg-light border-light hover:bg-light-dark active:bg-light-dark focus:bg-light-dark ">
                  Follow
                </a>
              </div>
            </div>
            <div className="flex flex-wrap justify-between">
              <div className="flex flex-wrap items-center">
                <a className="mr-3 mb-2 inline-flex items-center justify-center text-secondary-inverse rounded-full bg-neutral-100 hover:bg-neutral-200 transition-all duration-200 ease-in-out px-3 py-1 text-sm font-medium leading-normal">
                  {" "}
                  320 Following{" "}
                </a>
                <a className="mr-3 mb-2 inline-flex items-center justify-center text-secondary-inverse rounded-full bg-neutral-100 hover:bg-neutral-200 transition-all duration-200 ease-in-out px-3 py-1 text-sm font-medium leading-normal">
        ...
        <ul className="group text-white flex flex-wrap items-stretch text-[1.15rem] font-semibold list-none border-b-2 border-transparent border-solid active-assignments">
          ...
          <li className="flex mt-2 -mb-[2px]">
            <a className="py-5 mr-1 sm:mr-3 lg:mr-10 transition-colors duration-200 ease-in-out border-b-2 border-transparent group-[.active-assignments]:border-primary  text-muted hover:border-primary">
              {" "}
              Assignments{" "}
            </a>
          </li>
